...
const projects = [
  {
    name: "theoccupi",
    description:
      "An app that revolutionizes digital advertising by transforming simple pixels into dynamic marketing opportunities. The platform allows businesses to purchase and customize pixel spots, engaging users with interactive and visually compelling content.",
    tags: [
      {
        name: "react.js",
